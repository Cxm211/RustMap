...
#[no_mangle]
pub static mut BZ_HDR_B: UChar = 0x42 as libc::c_int as UChar;
#[no_mangle]
pub static mut BZ_HDR_Z: UChar = 0x5a as libc::c_int as UChar;
#[no_mangle]
pub static mut BZ_HDR_h: UChar = 0x68 as libc::c_int as UChar;
#[no_mangle]
pub static mut BZ_HDR_0: UChar = 0x30 as libc::c_int as UChar;
...
#[no_mangle]
pub static mut BLOCK_HEADER_HI: libc::c_ulong = 0x3141 as libc::c_ulong;
#[no_mangle]
pub static mut BLOCK_HEADER_LO: libc::c_ulong = 0x59265359 as libc::c_ulong;
#[no_mangle]
pub static mut BLOCK_ENDMARK_HI: libc::c_ulong = 0x1772 as libc::c_ulong;
#[no_mangle]
pub static mut BLOCK_ENDMARK_LO: libc::c_ulong = 0x45385090 as libc::c_ulong;
#[no_mangle]
...
unsafe fn main_0(mut argc: Int32, mut argv: *mut *mut Char) -> Int32 {
    ...
    while True != 0 {
        ...
        if b == 2 as libc::c_int {
            ...
            if (buffHi & 0xffff as libc::c_int as libc::c_uint) as libc::c_ulong
                == BLOCK_HEADER_HI && buffLo as libc::c_ulong == BLOCK_HEADER_LO
                || (buffHi & 0xffff as libc::c_int as libc::c_uint) as libc::c_ulong
                    == BLOCK_ENDMARK_HI && buffLo as libc::c_ulong == BLOCK_ENDMARK_LO
            {
    ...
    while True != 0 {
                ...
                .wrapping_add(1 as libc::c_int as libc::c_ulonglong)
        {
            ...
            bsPutUChar(bsWr, (BZ_HDR_0 as libc::c_int + 9 as libc::c_int) as UChar);
