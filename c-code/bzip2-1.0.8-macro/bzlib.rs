...
unsafe extern "C" fn ADD_CHAR_TO_BLOCK(mut zs: *mut EState, mut zchh0: UInt32) {
    ...
    if zchh != (*zs).state_in_ch && (*zs).state_in_len == 1 as libc::c_int {
        let mut ch: UChar = (*zs).state_in_ch as UChar;
        (*zs)
            .blockCRC = (*zs).blockCRC << 8 as libc::c_int
            ^ BZ2_crc32Table[((*zs).blockCRC >> 24 as libc::c_int ^ ch as libc::c_uint)
                as usize];
        (*zs).inUse[(*zs).state_in_ch as usize] = 1 as libc::c_int as Bool;
        *((*zs).block).offset((*zs).nblock as isize) = ch;
        (*zs).nblock += 1;
        (*zs).nblock;
        (*zs).state_in_ch = zchh;
    } else if zchh != (*zs).state_in_ch || (*zs).state_in_len == 255 as libc::c_int {
        if (*zs).state_in_ch < 256 as libc::c_int as libc::c_uint {
            add_pair_to_block(zs);
        }
        (*zs).state_in_ch = zchh;
        (*zs).state_in_len = 1 as libc::c_int;
    } else {
        (*zs).state_in_len += 1;
        (*zs).state_in_len;
    };
...
pub unsafe extern "C" fn BZ2_bzWriteOpen(
    ...
    BZ_SETERR(bzerror, bzf, 0 as libc::c_int);
    if f.is_null()
    ...
    {
        BZ_SETERR(bzerror, bzf, -(2 as libc::c_int));
        return 0 as *mut libc::c_void;
    }
    if ferror(f) != 0 {
        BZ_SETERR(bzerror, bzf, -(6 as libc::c_int));
        return 0 as *mut libc::c_void;
    }
    bzf = malloc(::core::mem::size_of::<bzFile>() as libc::c_ulong) as *mut bzFile;
    if bzf.is_null() {
        BZ_SETERR(bzerror, bzf, -(3 as libc::c_int));
        return 0 as *mut libc::c_void;
    }
    BZ_SETERR(bzerror, bzf, 0 as libc::c_int);
...
pub unsafe extern "C" fn BZ2_bzWrite(
    ...
    if (*bzf).writing == 0 {
        BZ_SETERR(bzerror, bzf, -(1 as libc::c_int));
        return;
    }
...
pub unsafe extern "C" fn BZ2_bzRead(
    ...
    while 1 as libc::c_int as Bool != 0 {
        ...
        {
            BZ_SETERR(bzerror, bzf, -(7 as libc::c_int));
            return 0 as libc::c_int;
        }
        if ret == 4 as libc::c_int {
            BZ_SETERR(bzerror, bzf, 4 as libc::c_int);
