...
static void fvswap(Int32 zzp1, Int32 zzp2, Int32 zzn, UInt32* fmap) {
    Int32 yyp1 = zzp1;
    Int32 yyp2 = zzp2;
    Int32 yyn  = zzn;
    while (yyn > 0) {
...
static Int32 fmin(Int32 a, Int32 b) {
    return (a < b) ? a : b;
}

static void fpush(Int32* stackLo, Int32* stackHi, Int32* sp, Int32 lz, Int32 hz) {
    stackLo[*sp] = lz;
    stackHi[*sp] = hz;
    (*sp)++;
}

static void fpop(Int32* stackLo, Int32* stackHi, Int32* sp, Int32* lz, Int32* hz) {
    (*sp)--;
    *lz = stackLo[*sp];
    *hz = stackHi[*sp];
}
...
*/
static void SET_BH(UInt32* bhtab, Int32 zz) {
    bhtab[zz >> 5] |= ((UInt32)1 << (zz & 31));
}

static void CLEAR_BH(UInt32* bhtab, Int32 zz) {
    bhtab[zz >> 5] &= ~((UInt32)1 << (zz & 31));
}

static Int32 ISSET_BH(UInt32* bhtab, Int32 zz) {
    return (bhtab[zz >> 5] & ((UInt32)1 << (zz & 31)));
}

static UInt32 WORD_BH(UInt32* bhtab, Int32 zz) {
    return bhtab[zz >> 5];
}

static Int32 UNALIGNED_BH(Int32 zz) {
    return zz & 0x01f;
}
...
static void mswap(UInt32* zz1, UInt32* zz2) {
    UInt32 zztmp = *zz1;
    *zz1 = *zz2;
    *zz2 = zztmp;
}

static void mvswap(Int32 zzp1, Int32 zzp2, Int32 zzn, UInt32* ptr) {
    Int32 yyp1 = zzp1;
    Int32 yyp2 = zzp2;
    Int32 yyn  = zzn;
    while (yyn > 0) {
...
static Int32 mmin(Int32 a, Int32 b) {
    return (a < b) ? a : b;
}

static void mpush(Int32 lz, Int32 hz, Int32 dz, Int32* stackLo, Int32* stackHi, Int32* stackD, Int32* sp) {
    stackLo[*sp] = lz;
    stackHi[*sp] = hz;
    stackD[*sp] = dz;
    (*sp)++;
...
static void mpop(Int32* lz, Int32* hz, Int32* dz, Int32* stackLo, Int32* stackHi, Int32* stackD, Int32* sp) {
    (*sp)--;
    *lz = stackLo[*sp];
    *hz = stackHi[*sp];
    *dz = stackD[*sp];
...
static Int32 mnextsize(Int32 az, Int32* nextHi, Int32* nextLo) {
    return nextHi[az] - nextLo[az];
}

static void mnextswap(Int32 az, Int32 bz, Int32* nextLo, Int32* nextHi, Int32* nextD) {
    Int32 tz;
    tz = nextLo[az];
    nextLo[az] = nextLo[bz];
    nextLo[bz] = tz;
...
static Int32 BIGFREQ(Int32 b, UInt32* ftab) {
