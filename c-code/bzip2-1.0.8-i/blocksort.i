                      ...
                      Int32 hiSt )
{
   ...
   while (sp > 0) {
      ...
      { if (!(sp < FALLBACK_QSORT_STACK_SIZE - 1)) BZ2_bz__AssertH__fail ( 1004 ); };
...
const Int32 MAIN_QSORT_DEPTH_THRESH = (2 + 12);
                  ...
                  Int32* budget )
{
   ...
   while (sp > 0) {
      ...
      { if (!(sp < MAIN_QSORT_STACK_SIZE - 2)) BZ2_bz__AssertH__fail ( 1001 ); };
